...
void bsp_InitExtSDRAMData(void);
...
*/
    ...
    __HAL_LINKDMA(g_hsdram, hmdma, mdma_handle);
    ...
    HAL_NVIC_SetPriority(SDRAM_MDMAx_IRQn, 15, 0);
...
void BSP_SDRAM_IRQHandler(uint32_t Instance)
{
  ...
  HAL_MDMA_IRQHandler(g_hsdram[Instance].hmdma);
}
