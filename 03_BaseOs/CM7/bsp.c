...
/**
 * @brief initialize core system. It only need to be invorked once
 * @param None
 * @retval None
 */
...
static void MPU_Config(void)
{
    ...
    /* Configure the SDRAM region as Write back, Read allocate，Write allocate */
    MPU_InitStruct.Enable           = MPU_REGION_ENABLE;
    MPU_InitStruct.BaseAddress      = 0xD0000000U; /* SDRAM_DEVICE01_ADDR */
