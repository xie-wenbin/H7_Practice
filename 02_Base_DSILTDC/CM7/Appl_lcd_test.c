#include "Appl_lcd_test.h"
#include "bsp_lcd_hw.h"
#include "bsp_lcd_svc.h"
#include "stdio.h"

// extern const uint32_t _aclufei[128*128*4];
extern const uint8_t FileArray[];
LcdDrawPoint PolygonPonits[5] = {
    {250, 120},
    {300, 100},
    {320, 120},
    {280, 150},
...
LcdDrawPoint PolygonPonits_Internal[5] = {
    {255, 125},
    {295, 105},
    {315, 120},
    {275, 145},
...
void BSP_LCD_DrawExampleTest(void)
{
    ...
    LCD_UTIL_DrawLine(120, 120, 240, 240, 0xFF7F7F4FUL);

    //BSP_LCD_FillRect(360, 360, 120, 120, 0xFFFF00FFUL);

    LCD_UTIL_DisplayStringAtLine(1, FONTSIZE_24, 0xFF0000FFUL, (uint8_t *)"LCD_DSI_CmdMode_SingleBuffer");

    LCD_UTIL_DrawBitmap(400, 300, (uint8_t*)FileArray);

    LCD_UTIL_DrawRect(600, 300, 100, 100, 0xFF7F7F4FUL);
    LCD_UTIL_DrawCircle(650, 250, 48, 0xFF4F4F4FUL);
    LCD_UTIL_DrawPolygon(&PolygonPonits[0], 5, 0xFF353535UL);
    LCD_UTIL_DrawEllipse(400, 120, 60, 40, 0xFFFF00FFUL);

    LCD_UTIL_FillRect(610, 310, 80, 80, 0xFFDA7E22UL);
    LCD_UTIL_FillCircle(650, 250, 30, 0xFF22DA7EUL);
    LCD_UTIL_FillPolygon(&PolygonPonits_Internal[0], 5, 0xFF7EDA22UL);
    LCD_UTIL_FillEllipse(400, 120, 50, 20, 0xFFFFAD00UL);
